...
function nonprof() {
  ...
  toggle.on('mousedown', function () {
    non_prof_toggle = !non_prof_toggle;
    console.log(non_prof_toggle);
    if (non_prof_toggle)
      non_prof.fadeIn(non_prof_fade_time);
    else
      non_prof.fadeOut(non_prof_fade_time);
  });
}